...
This repository hosts the Lazarus bindings for the [ACR122U](https://www.acs.com.hk/en/products/3/acr122u-usb-nfc-reader/) USB NFC Reader like this one: <br>
<img src="GFX/NFC_reader.png" alt="drawing" width="200"/>
<br>

The reader's datasheet can be downloaded [here](https://www.acs.com.hk/download-manual/419/API-ACR122U-2.04.pdf).
...
### Linux
As the reader is sometimes detected incorrectly, use the [nfc_reader_healthcheck](scripts/nfc_reader_healthcheck.sh) script to detect the reader. You can also follow the [Readme](scripts/Readme.md) to get the reader working first.
